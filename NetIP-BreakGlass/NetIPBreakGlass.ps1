    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#111827" Padding="18,14">
            <Grid>
                ...
                <StackPanel>
                    <TextBlock x:Name="WPFAppTitle" Text="NetIP Entra Break Glass Configurator" Foreground="White" FontSize="24" FontWeight="SemiBold"/>
                    <TextBlock Text="Simpel Microsoft Graph-baseret opsætning af break-glass konti og CA-exclude gruppe." Foreground="#CBD5E1" Margin="0,4,0,0"/>
                </StackPanel>
